...
const { parseFrom: _parseFrom, parseAddressList: _parseAddressList } =
...
const cleanEmailAddresses = (emails: string | undefined) => {
 ...
 */
const formatMimeRecipients = (recipients: string | string[]) => {
